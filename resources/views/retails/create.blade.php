            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('retails.store') }}" method="POST">
                            {{ csrf_field() }}

                            <input type="text" name="upload_file" value="0" hidden>
                            ...
                            {{--<div class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">--}}
                                ...
                                {{--<div class="col-sm-9">--}}
                                    {{--<input type="text" class="form-control" name="district" id="inputDistrict" value="{{ old('district') }}">--}}
                            ...
                            {{--<div class="form-group{{ $errors->has('sub_district') ? ' has-error' : '' }}">--}}
                                ...
                                {{--<div class="col-sm-9">--}}
                                    {{--<input type="text" class="form-control" name="sub_district" id="inputSubDistrict" value="{{ old('sub_district') }}">--}}
